<?php
include("header.php");
if(!isset($_SESSION['name'])){echo '<script>window.location="sign.php"</script>';;}
?>
            ...
            <div class="row">
                <div class="col-lg-12">
				 ...
				 <?php
						 ...
						 $course=$row['course'];
							?>
<a href="question.php?id=<?php echo $id;?>" class="btn btn-primary" style="width:150px;margin-left:10px;height:40px;font-size:20px;"><?php echo  $row['course'];?></a></h1>
<?php
						}
					?>
					<br><br>
