            ...
            <div class="panel-heading">
					  ...
					  <th style="border:1px solid black;text-align:center;"><br>ID</th>
					   ...
					   //echo "SELECT * FROM quiz WHERE course_id='$id'";
						...
						{
	?>
	<tr id="<?php echo $row['id'];?>"><td style="border:1px solid black;text-align:center;">
<?php
echo $i;
$i++;
echo ".";
...
<td style="border:1px solid black;text-align:center;"> <button class="btn btn-danger btn-sm remove">Delete</button></td>
	</tr>
	<?php
}
?>
