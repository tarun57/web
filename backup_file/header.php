...
$sql = "SELECT id, cat_image, cat_name, cat_desc FROM images ";
        ...
        <div class="container" style="line-height:1.5px;">
            <div class="row">
				...
				<strong>Email: </strong>Pizone@gmail.com
                    &nbsp;&nbsp;
                    <strong>Support: </strong>+99-000-6461-02
					&emsp;&emsp;&emsp;&emsp;
...
&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
  ...
  if($_SESSION['name']==true){ 
    ...
    elseif($_SESSION['name']==false) 
        echo '<a href="loc.php"><span class ="glyphicon glyphicon-log-in" style="color:white;margin-left:10px;">  Login/Register</span></a>';
    ?>
	</div>
	</div>
    </header>
