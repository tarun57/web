...
<?php
					...
					<br><br>
					   ...
					   //echo "SELECT * FROM quiz WHERE course_id='$id'";
		       		 $query = mysql_query("SELECT `id`, `question`, `a1`, `a2`, `a3`, `a4`, `correct` FROM `quiz` WHERE course_id='$id'");
					 $i=1;
...
<div class="container" style="color:black;">
  ...
  <button type="submit" class="btn btn-info btn-lg btnSendMail" data-toggle="modal" name="myBtn"  data-target="#myBtn"  style="margin-bottom:20px;margin-left:40%;">Submit</button></span>

  <!-- Modal -->
  <div class="modal fade" id="myBtn" role="dialog" style="margin-top:3%;">
...
var secondsleft = 5; // give seconds you wish
