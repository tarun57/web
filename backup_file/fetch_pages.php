...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
	$results = mysqli_query($connecDB, "SELECT id, question, a1,a2,a3,a4 FROM quiz where course_id='$id' ORDER BY id ASC LIMIT $position, $item_per_page");
}
else {
...
<br><br>
<input type="radio" name="seconds"  qid="<?php echo $row['id']; ?>" class="rbtn" value="<?php echo $row['a1']; ?>" ><?php echo $row['a1']; ?><br>
<input type="radio" name="seconds" qid="<?php echo $row['id']; ?>" class="rbtn" value="<?php echo $row['a2']; ?>" ><?php echo $row['a2']; ?> <br>
<input type="radio" name="seconds" qid="<?php echo $row['id']; ?>" class="rbtn" value="<?php echo $row['a3']; ?>" ><?php echo $row['a3']; ?> <br>
<input type="radio" name="seconds" qid="<?php echo $row['id']; ?>" class="rbtn" value="<?php echo $row['a4']; ?>" ><?php echo $row['a4']; ?><br><br><br>
<?php
$page_number++;
}
echo '</ul>';
...
{
	?>
	<input type="submit" name="submit" id="submit" value="Get Result">
	<div id="response"></div>
	<?php
}
}
