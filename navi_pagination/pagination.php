...
<div id="pagination_div">
  ...
  <br>
  <input type="radio" id="seconds" name="seconds" class="rbtn" value="<?php echo $row['a1']; ?>"><?php echo $row['a1']; ?><br>
  <input type="radio" id="seconds" name="seconds" class="rbtn" value="<?php echo $row['a2']; ?>"><?php echo $row['a2']; ?> <br>
  <input type="radio" id="seconds" name="seconds" class="rbtn" value="<?php echo $row['a3']; ?>"><?php echo $row['a3']; ?> <br>
  <input type="radio" id="seconds" name="seconds" class="rbtn" value="<?php echo $row['a4']; ?>"><?php echo $row['a4']; ?><br><br><br>
</div>
</form>
